...
const Main = () => {
	...
	return (
		<div className={classes.Main}>
          ...
          <Message author="Covid Assistant" msg="Here are some news articles" articles={articles} />
          <Message author="User" msg="Show me Coronavirus India Statistics" />
					<Message author="Covid Assistant" msg="Here are the stats for India" stats={stats} />
				</div>
